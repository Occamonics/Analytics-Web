...
import {getDailySessions, getPercentagePerCountry, getSessionsPerCountry} from "../../lib/api/insights.api";
...
const SessionsPerCountry = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const {success, data, message} = await getPercentagePerCountry();
            if (success) {
                setRawData(data);
